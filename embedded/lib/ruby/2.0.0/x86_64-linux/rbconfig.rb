...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/vagrant-substrate/staging/embedded")
  ...
  CONFIG["configure_args"] = " '--prefix=/vagrant-substrate/staging/embedded' '--disable-debug' '--disable-dependency-tracking' '--disable-install-doc' '--enable-shared' '--with-opt-dir=/vagrant-substrate/staging/embedded' '--enable-load-relative' 'CFLAGS=-I/vagrant-substrate/staging/embedded/include' 'LDFLAGS=-L/vagrant-substrate/staging/embedded/lib '"
  ...
  CONFIG["rubyw_install_name"] = ""
  CONFIG["LIBRUBY_DLDFLAGS"] = "-Wl,-soname,lib$(RUBY_SO_NAME).so.$(MAJOR).$(MINOR) -L/vagrant-substrate/staging/embedded/lib  -Wl,-R/vagrant-substrate/staging/embedded/lib "
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/vagrant-substrate/staging/embedded/lib  -Wl,-R/vagrant-substrate/staging/embedded/lib "
  CONFIG["ALLOCA"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " -I/vagrant-substrate/staging/embedded/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/vagrant-substrate/staging/embedded/lib  -fstack-protector -rdynamic -Wl,-export-dynamic -L/vagrant-substrate/staging/embedded/lib  -Wl,-R/vagrant-substrate/staging/embedded/lib "
  CONFIG["CFLAGS"] = "-I/vagrant-substrate/staging/embedded/include -fPIC"
  CONFIG["CC"] = "gcc"
